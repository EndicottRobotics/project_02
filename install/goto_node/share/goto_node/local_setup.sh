...
: ${AMENT_CURRENT_PREFIX:="/root/ros2_ws/src/project_02/install/goto_node"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/goto_node/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/goto_node/environment/path.sh"
