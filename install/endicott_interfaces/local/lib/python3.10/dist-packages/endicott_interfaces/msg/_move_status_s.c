...
bool endicott_interfaces__msg__move_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // theta_error
    PyObject * field = PyObject_GetAttrString(_pymsg, "theta_error");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->theta_error = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of MoveStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("endicott_interfaces.msg._move_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MoveStatus");
  ...
  {  // theta_error
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->theta_error);
    {
      int rc = PyObject_SetAttrString(_pymessage, "theta_error", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
