...
class Metaclass_MoveStatus(type):
    """Metaclass of message 'MoveStatus'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('endicott_interfaces')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'endicott_interfaces.msg.MoveStatus')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__move_status
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__move_status
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__move_status
...
class MoveStatus(metaclass=Metaclass_MoveStatus):
    ...
    def __eq__(self, other):
        ...
        if self.distance_error != other.distance_error:
            return False
        if self.theta_error != other.theta_error:
            return False
        return True
    ...
    def theta_error(self):
        """Message field 'theta_error'."""
        return self._theta_error

    @theta_error.setter
    def theta_error(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'theta_error' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'theta_error' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._theta_error = value
